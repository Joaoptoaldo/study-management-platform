...
class SubjectServiceTest {
    ...
    void findAll_authenticatedUser_returnsUserSubjects() {
        // ARRANGE
        when(subjectRepository.findByUserId(1L)).thenReturn(List.of(subject));
        ...
        assertThat(result.get(0).getSubjectName()).isEqualTo("Matemática");
        verify(subjectRepository).findByUserId(1L);
    }
