...
@Import(com.studyplatform.config.SecurityConfig.class)
...
class AuthControllerTest {
    ...
    @MockBean
    private com.studyplatform.security.JwtService jwtService;

    @MockBean
    private com.studyplatform.security.UserDetailsServiceImpl userDetailsService;
